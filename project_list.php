				...
				<tbody>
					...
					while($row= $qry->fetch_assoc()):
						...
						$desc=str_replace(array("<li>","</li>"), array("",", "), $desc);
					 	...
					 	$tprog = $conn->query("SELECT * FROM stage_list where project_id = {$row['id']}")->num_rows;
		                $cprog = $conn->query("SELECT * FROM stage_list where project_id = {$row['id']} and status = 3")->num_rows;
					...
					<tr>
						...
						<td class="text-center">
							<?php
							  ...
							  }elseif($stat[$row['status']] =='Harvested'){
